...
(async () => {
  ...
  for (const table of ['opportunity_reviews','opportunity_review_acknowledgements','opportunity_contact_verification_snapshots','opportunity_review_bases','opportunity_review_presentations','opportunity_review_completions','opportunity_outreach_progression_events','opportunity_review_invalidations']) assert(after.some(item => item.name === table), `${table} must exist`);
